...
const config = require('../config/webpack.config.prod.en');
...
// First of all, create symlink for deault language set
if (fs.existsSync('src/Translation')) {
    fs.unlinkSync('src/Translation');
}
fs.symlinkSync('../Translation/En', './src/Translation', 'dir');
...
measureFileSizesBeforeBuild(paths.appBuild)
  ...
  .then(
    ({ stats, previousFileSizes, warnings }) => {
      ...
      // rename index.html -> index.en.html
      fs.renameSync('build/index.html', 'build/index.html.en');
