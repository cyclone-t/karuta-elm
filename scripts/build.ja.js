...
const config = require('../config/webpack.config.prod.ja');
...
fs.symlinkSync('../Translation/Ja', './src/Translation', 'dir');
...
measureFileSizesBeforeBuild(paths.appBuild)
  ...
  .then(
    ({ stats, previousFileSizes, warnings }) => {
      ...
      // rename index.html -> index.ja.html
      fs.renameSync('build/index.html', 'build/index.html.ja');
